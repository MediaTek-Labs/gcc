...
(define_expand "ctz<mode>2"
  ...
  "(ISA_HAS_CTZ_CTO
   || (TARGET_NANOMIPS == NANOMIPS_NMF && <MODE>mode == SImode))")
  ...
  "!TARGET_MIPS16"
{
  switch (which_alternative)
    ...
    case 3: return mips_output_load_store (operands[0], operands[1],
					   <SHORT:MODE>mode, true/*zero_extend_p*/,
					   true/*load_p*/);
    default:
      gcc_unreachable ();
    }
   ...
   || (ISA_HAS_SEH && <SHORT:MODE>mode == HImode)"
{
  if (which_alternative == 0)
    ...
    return mips_output_load_store (operands[0], operands[1], <SHORT:MODE>mode,

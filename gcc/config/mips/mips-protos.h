...
extern bool nanomips_masks_ok_for_ins_p (unsigned HOST_WIDE_INT,
					 unsigned HOST_WIDE_INT,
					 unsigned HOST_WIDE_INT);
extern bool nanomips_use_ins_for_shift_mask_p (unsigned HOST_WIDE_INT,
					       unsigned HOST_WIDE_INT);
